package com.chawran.core.util.http;
...
public class HttpClientUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		requestGet.setRequestUrl("http://localhost:8080/tsp-api/api/public/test/testQueryParameter?name=aizheng");
		...
		// POST
		String json = "{\"id\":\"aizheng\",\"name\":\"艾铮\"}";
		
		HttpClientRequest requestPost = new HttpClientRequest();
		requestPost.setRequestUrl("http://localhost:8080/tsp-api/api/public/test/testRequestBody");
		...
		requestHeader.setRequestUrl("http://localhost:8080/tsp-api/api/private/test/testToken?name=aizheng");
